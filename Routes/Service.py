...
@router.get("/debt", status_code=status.HTTP_200_OK, response_class=HTMLResponse)
...
@router.post("/debt", status_code=status.HTTP_202_ACCEPTED, response_class=HTMLResponse)
